...
export function CameraToggle() {
  ...
  function handleClick() {
    if (!isCameraOn) setScreenShareOn(false);
    toggleCamera();
  }
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-20 z-20 flex h-11 w-11 items-center justify-center rounded-full border border-jarvis-purple/20 bg-navy-deep/40 backdrop-blur-md transition-all duration-200 hover:border-jarvis-purple/40 hover:bg-navy-deep/60 active:scale-95"
    >
      {isCameraOn ? (
        <svg
