...
export function AssistantExperience() {
  ...
  return (
    <>
      ...
      <header className="pointer-events-none absolute left-6 top-6 z-10 flex items-center gap-2 text-xs uppercase tracking-[0.35em] text-slate-500">
        <span className="h-1.5 w-1.5 rounded-full bg-jarvis-cyan/70" />
        Jarvis · Smart Home
      </header>
