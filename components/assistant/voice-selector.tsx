...
export function VoiceSettingsButton() {
  ...
  return (
    <button
      ...
      aria-label="Menü"
      className="fixed right-6 top-6 z-30 flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl transition-all duration-300 hover:border-white/10 hover:bg-white/[0.06] active:scale-95"
    >
      <div className="flex flex-col items-center justify-center gap-[5px]">
        <span
          className={`block h-[1.5px] w-4 rounded-full bg-slate-400 transition-all duration-300 ${
...
export function VoiceSelectorModal() {
  ...
  return (
    <>
      ...
      >
        <div className="overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0b0f28]/75 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.8)] backdrop-blur-3xl">
          {/* Top accent line */}
